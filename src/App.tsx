...
const AboutContent = () => (
  <div className="p-8 font-sans text-gray-800 h-full overflow-y-auto bg-gradient-to-br from-white to-gray-50">
    <div className="flex flex-col items-center mb-8">
      ...
      <p className="text-blue-600 font-medium mt-1">Aspiring AI Software Engineer | BIT Bengaluru</p>
    </div>
    ...
    <div className="max-w-3xl mx-auto space-y-8 pb-8">
      <section className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <p className="leading-relaxed text-gray-600 text-lg">
          I am a Electronics and Communication Engineering Final year Student from BIT Bengaluru (VTU University) with a CGPA of 8.20/10. 
          Currently  <span className="font-semibold text-green-700">Data Science Intern At KodNest</span>.
      ...
      <section className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <ul className="space-y-3">
          ...
          {/* <li className="flex items-start">
            ...
            <span className="text-gray-700">Rajya Purash</span>
          </li> */}
        </ul>
      </section>
    </div>
      ...
      <div className="space-y-1">
        ...
        <div className="pl-6 mt-2">
          ...
          <div className="pl-4 group hover:bg-white/5 p-1 rounded transition-colors">
            ...
            <span className="pl-4 text-sky-300">"company"</span>: <span className="text-orange-300">"KodNest"</span>,<br/>
            <span className="pl-4 text-sky-300">"role"</span>: <span className="text-orange-300">"Data Science Intern"</span>,<br/>
        ...
        <div className="pl-6 mt-2">
          ...
          <div className="pl-4 group hover:bg-white/5 p-1 rounded transition-colors">
            <span className="text-yellow-300">{`{`}</span><br/>
            <span className="pl-4 text-sky-300">"college"</span>: <span className="text-orange-300">"BIT Bengaluru"</span>,<br/>
            <span className="pl-4 text-sky-300">"degree"</span>: <span className="text-orange-300">"B.E ECE"</span>,<br/>
            <span className="pl-4 text-sky-300">"gpa"</span>: <span className="text-orange-300">"8.20/10"</span><br/>
            <span className="text-yellow-300">{`}`}</span>
          </div>
          ],
        </div>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-2 text-gray-800">
            <BookOpen className="text-blue-500" /> Ongoing Project
          </h2>
          <div className="block group">
            <h3 className="font-bold text-lg text-gray-800 group-hover:text-blue-600 transition-colors">KPPC Boys Hostel Portal(Ongoing)</h3>
            <p className="text-xs font-semibold text-blue-500 uppercase tracking-wide mt-1">March 2026</p>
            <p className="text-sm text-gray-600 mt-2 leading-relaxed">A web-based portal for managing the boys' hostel at KPPC, including room allocation, maintenance requests, and student records.</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a href="https://linkedin.com/in/kumar-ganachari" target="_blank" rel="noreferrer" className="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors gap-3">
        ...
        <div className="col-span-1 md:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-xl p-4 hover:border-blue-300 transition-colors">
              <h3 className="font-bold text-lg text-blue-600">DevGPT</h3>
              <p className="text-xs text-gray-500 mt-1 mb-2">ReactJS, Tailwind, Gemini API,Node.js,Express.js,MongoDB</p>
              <p className="text-sm text-gray-600">DevGPT is an AI-powered developer assistant that helps programmers generate code, debug errors, and understand programming concepts instantly using the Gemini API.</p>
            </div>

            <div className="border border-gray-200 rounded-xl p-4 hover:border-blue-300 transition-colors">
              <h3 className="font-bold text-lg text-blue-600">TradeSphere</h3>
              <p className="text-xs text-gray-500 mt-1 mb-2">React, Tailwind CSS, Node.js, Express.js,WebSockets, TradingView Charts API,Docker, AWS</p>
...
const TerminalContent = () => {
  const [history, setHistory] = useState<string[]>(["Welcome to KumarOS v1.0", "Type 'help' to see commands."]);
    ...
    if (e.key === 'Enter') {
      ...
      switch (cmd) {
        case 'help':
          ...
          break;
        case 'about':
          newHistory.push("Kumareshwar Ganachari | Aspiring AI Software Engineer | BIT Bengaluru");
          break;
        case 'projects':
          newHistory.push("1. DevGPT (React/Gemini)", "2. TradeSphere(MERN)", "3. TravelNest(React)");
          break;
        case 'skills':
          newHistory.push("Languages:Python,JS", "Tools:MERN,Bootstrap,SQL,GitHub", "AI:LLMs,Prompt Engg");
          break;
        case 'socials':
          newHistory.push("GitHub: KumarGanachari", "LinkedIn: Kumar-ganachari");
          break;
        case 'clear':
          setHistory([]);
          setInput("");
...
const TopBar = ({ title, activeMenu, setActiveMenu }: TopBarProps) => {
  ...
  const menus: Record<string, MenuItem[]> = {
    ...
    File: [
      ...
      { type: "separator" },
      { label: "Download Resume", action: () => window.open("https://linkedin.com/in/kumar-ganachari", "_blank") },
    ],
    ...
    Help: [
      ...
      { label: "View Source Code", action: () => window.open("https://github.com/KumarGanachari2004", "_blank") },
    ],
  };
...
const App = () => {
  ...
  const openApp = (appId: string) => {
    ...
    if (existingWindow) {
      ...
      switch(appId) {
        case 'finder': content = <AboutContent />; title = 'Kumareshwar Ganachari'; break;
